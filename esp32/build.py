...
convert(find('bitmap/bwy'))
convert(find('db'))
convert(find('display'))
convert(find('lang'))
convert(find('setup'))
convert(find('ui'))
convert(find('ui/acep'))
convert(find('ui/bwy'))
convert(find('web'))
...
command('rm {}'.format(Path(dwd, 'setup/__init__.py')))
command('rm {}'.format(Path(dwd, 'setup/display.mpy')))
command('rm {}'.format(Path(dwd, 'setup/epd_acep.py')))
command('rm {}'.format(Path(dwd, 'setup/epd_bwy.py')))
command('rm {}'.format(Path(dwd, 'setup/pins.mpy')))
command('rm {}'.format(Path(dwd, 'db/_alert.mpy')))
command('rm {}'.format(Path(dwd, 'db/_beep.mpy')))
command('rm {}'.format(Path(dwd, 'db/_connection.mpy')))
command('rm {}'.format(Path(dwd, 'db/_display.mpy')))
command('rm {}'.format(Path(dwd, 'db/_led.mpy')))
command('rm {}'.format(Path(dwd, 'db/_location.mpy')))
command('rm {}'.format(Path(dwd, 'db/_spot.mpy')))
command('rm {}'.format(Path(dwd, 'db/_sys.mpy')))
command('rm {}'.format(Path(dwd, 'db/_temp.mpy')))
command('rm {}'.format(Path(dwd, 'db/_time.mpy')))
command('rm {}'.format(Path(dwd, 'db/_ui.mpy')))
command('rm {}'.format(Path(dwd, 'db/_vbat.mpy')))
