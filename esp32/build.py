...
command('rm {}'.format(Path(dwd, 'config/time.mpy')))
command('rm {}'.format(Path(dwd, 'config/time.py')))
...
command('rm {}'.format(Path(dwd, 'var/_alert.mpy')))
command('rm {}'.format(Path(dwd, 'var/_display.mpy')))
